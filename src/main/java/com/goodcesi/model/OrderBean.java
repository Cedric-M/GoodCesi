 ...
 * 
 * Si on annote avec @ConversationScoped (ou autre annotation de scope) alors il ne faut pas annoter de méthodes avec @Remove car c'est le container CDI qui est chargé de gérer le cycle de vie du bean.
